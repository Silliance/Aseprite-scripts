-- get the union selection of untransparent pixels of all selected layers/cels and layers/cels in selected folders and remove it from current selection
-- if no layers/cels is selected, it will get the selection of untransparent pixels in the current cel and remove it from current selection

if app.activeSprite.selection.isEmpty then return end
...
app.activeSprite.selection:subtract(slt)
